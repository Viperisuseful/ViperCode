...
export const RELAY_LINK_PROOF_TYP = "viper-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "viper-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "viper-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "viper-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "viper-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "viper-env-activity+jwt";
