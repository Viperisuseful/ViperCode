  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Viper Code prerelease is available for nightly testers."
          : "A new Viper Code latest release is available.",
...
).pipe(Command.withDescription("Post a Viper Code release announcement to Discord."));
