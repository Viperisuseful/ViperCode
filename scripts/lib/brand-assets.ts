export const BRAND_ASSET_PATHS = {
  productionWindowsIconIco: "assets/prod/viper-windows.ico",
  productionWebFaviconIco: "assets/prod/viper-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/viper-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/viper-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/viper-web-apple-touch-180.png",

  nightlyWindowsIconIco: "assets/prod/viper-windows.ico",
  nightlyWebFaviconIco: "assets/prod/viper-web-favicon.ico",
  nightlyWebFavicon16Png: "assets/prod/viper-web-favicon-16x16.png",
  nightlyWebFavicon32Png: "assets/prod/viper-web-favicon-32x32.png",
  nightlyWebAppleTouchIconPng: "assets/prod/viper-web-apple-touch-180.png",

  developmentDesktopIconPng: "assets/prod/viper-icon-512.png",
  developmentWindowsIconIco: "assets/prod/viper-windows.ico",
  developmentWebFaviconIco: "assets/prod/viper-web-favicon.ico",
  developmentWebFavicon16Png: "assets/prod/viper-web-favicon-16x16.png",
  developmentWebFavicon32Png: "assets/prod/viper-web-favicon-32x32.png",
  developmentWebAppleTouchIconPng: "assets/prod/viper-web-apple-touch-180.png",
} as const;
