...
import type { RelayDeliveryResult } from "@vipercode/contracts/relay";
...
>()("vipercode-relay/agentActivity/ApnsDeliveryQueue/ApnsDeliveryQueueSender") {}
...
export class ApnsDeliveryQueue extends Context.Service<ApnsDeliveryQueue, ApnsDeliveryQueueShape>()(
  "vipercode-relay/agentActivity/ApnsDeliveryQueue",
) {}
