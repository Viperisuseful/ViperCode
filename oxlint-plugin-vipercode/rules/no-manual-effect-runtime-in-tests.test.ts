...
const rule = createOxlintRuleHarness("vipercode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("vipercode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("vipercode/no-manual-effect-runtime-in-tests");
