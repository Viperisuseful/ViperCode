...
} from "@vipercode/shared/advertisedEndpoint";
import type {
  AdvertisedEndpoint,
...
import { readTailscaleStatus } from "@vipercode/tailscale";
...
>()("@vipercode/desktop/backend/DesktopServerExposure") {}
...
>()("@vipercode/desktop/backend/DesktopServerExposure/DesktopNetworkInterfacesService") {}
