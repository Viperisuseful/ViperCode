...
>()("@vipercode/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__VIPERCODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__VIPERCODE_ENV_${name}_END__`;
