import type { DesktopSshPasswordPromptRequest } from "@vipercode/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@vipercode/contracts";
import type { SshPasswordRequest } from "@vipercode/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "Viper Code window is not available for SSH authentication.";
...
>()("@vipercode/desktop/ssh/DesktopSshPasswordPrompts") {}
