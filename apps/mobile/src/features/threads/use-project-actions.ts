...
import { EnvironmentScopedProjectShell, type VcsRef } from "@vipercode/client-runtime";
import {
  CommandId,
...
import { buildTemporaryWorktreeBranchName, sanitizeFeatureBranchName } from "@vipercode/shared/git";
