...
import type { ComposerTriggerKind } from "@vipercode/shared/composerTrigger";
import type { ServerProviderSkill, ServerProviderSlashCommand } from "@vipercode/contracts";
