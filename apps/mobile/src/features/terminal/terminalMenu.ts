import type { KnownTerminalSession } from "@vipercode/client-runtime";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@vipercode/contracts";
...
} from "@vipercode/shared/terminalLabels";
