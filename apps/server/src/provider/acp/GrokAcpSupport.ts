import { type GrokSettings, ProviderDriverKind } from "@vipercode/contracts";
...
import { normalizeModelSlug } from "@vipercode/shared/model";
...
const VIPER_CODE_OAUTH_REFERRER = "vipercode";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: VIPER_CODE_OAUTH_REFERRER,
    },
  };
}
