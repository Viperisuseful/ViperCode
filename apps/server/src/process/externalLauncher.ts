...
import { isCommandAvailable, type CommandAvailabilityOptions } from "@vipercode/shared/shell";
...
export { isCommandAvailable } from "@vipercode/shared/shell";
...
export class ExternalLauncher extends Context.Service<ExternalLauncher, ExternalLauncherShape>()(
  "viper/process/externalLauncher",
) {}
