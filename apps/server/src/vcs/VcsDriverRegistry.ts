...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@vipercode/contracts";
import { VcsUnsupportedOperationError } from "@vipercode/contracts";
