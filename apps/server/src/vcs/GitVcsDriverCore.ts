...
import { dedupeRemoteBranchesWithLocalMatches } from "@vipercode/shared/git";
import { compactTraceAttributes } from "@vipercode/shared/observability";
import { decodeJsonResult } from "@vipercode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `vipercode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
