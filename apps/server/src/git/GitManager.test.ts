...
import { GitCommandError, TextGenerationError } from "@vipercode/contracts";
...
> {
  return Effect.gen(function* () {
    const remoteDir = yield* makeTempDir("vipercode-git-remote-");
  ...
  const execute: GitHubCliShape["execute"] = (input) => {
    ...
    if (args[0] === "pr" && args[1] === "view") {
      const pullRequest: FakePullRequest = scenario.pullRequest ?? {
        number: 101,
        title: "Pull request",
        url: "https://github.com/viperisuseful/codething-mvp/pull/101",
        baseRefName: "main",
...
const GitManagerTestLayer = GitVcsDriver.layer.pipe(
  Layer.provide(ServerConfig.layerTest(process.cwd(), { prefix: "viper-git-manager-test-" })),
  Layer.provideMerge(VcsProcess.layer),
  Layer.provideMerge(NodeServices.layer),
);
...
it.layer(GitManagerTestLayer)("GitManager", (it) => {
  it.effect("status includes PR metadata when branch already has an open PR", () =>
    Effect.gen(function* () {
      const repoDir = yield* makeTempDir("vipercode-git-manager-");
            ...
            JSON.stringify([
              {
                number: 13,
                title: "Existing PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/13",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: " https://github.com/viperisuseful/codething-mvp/pull/14 ",
                baseRefName: " main ",
            ...
            JSON.stringify([
              {
                number: 0,
                title: "invalid",
                url: "https://github.com/viperisuseful/codething-mvp/pull/0",
                baseRefName: "main",
              ...
              },
              {
                ...
                url: " https://github.com/viperisuseful/codething-mvp/pull/15 ",
                baseRefName: " main ",
            ...
            JSON.stringify([
              {
                number: 16,
                title: "Closed PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/16",
                baseRefName: "main",
              ...
              },
              {
                number: 17,
                title: "Merged PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/17",
                baseRefName: "main",
                headRefName: "feature/status-lowercase-state",
                state: "merged",
  ...
  it.effect("status returns an explicit non-repo result for non-git directories", () =>
    Effect.gen(function* () {
      const cwd = yield* makeTempDir("vipercode-git-manager-non-repo-");
      const { manager } = yield* makeManager();
  ...
  it.effect("status returns an explicit non-repo result for deleted directories", () =>
    Effect.gen(function* () {
      const rootDir = yield* makeTempDir("vipercode-git-manager-missing-dir-");
  ...
  it.effect("status briefly caches repeated lookups for the same cwd", () =>
    Effect.gen(function* () {
      ...
      const existingPr = {
        number: 113,
        title: "Cached PR",
        url: "https://github.com/viperisuseful/codething-mvp/pull/113",
        baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/Viperisuseful/ViperCode/pull/1661",
                  baseRefName: "main",
                  headRefName: "main",
                  state: "OPEN",
                  ...
                  headRepository: {
                    nameWithOwner: "lnieuwenhuis/vipercode",
                  },
                  headRepositoryOwner: {
                    login: "lnieuwenhuis",
                  },
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["checkout", "-b", "vipercode/pr-488/statemachine"]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/viperisuseful/codething-mvp/pull/488",
                  baseRefName: "main",
        ...
        const status = yield* manager.status({ cwd: repoDir });
        expect(status.refName).toBe("vipercode/pr-488/statemachine");
        expect(status.pr).toEqual({
          number: 488,
          title: "Rebase this PR on latest main",
          url: "https://github.com/viperisuseful/codething-mvp/pull/488",
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "origin",
          "git@github.com:viperisuseful/codething-mvp.git",
          originDir,
        );
        ...
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "my-org/upstream",
          "ssh://git@github.com/viperisuseful/codething-mvp.git",
          upstreamDir,
        );
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              ...
              "effect-atom": JSON.stringify([
                {
                  number: 1618,
                  title: "Correct PR",
                  url: "https://github.com/Viperisuseful/ViperCode/pull/1618",
                  baseRefName: "main",
              ...
              "upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/Viperisuseful/ViperCode/pull/1518",
                  baseRefName: "main",
              ...
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "viperisuseful:effect-atom": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "my-org/upstream:effect-atom": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "viperisuseful:upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/Viperisuseful/ViperCode/pull/1518",
            ...
            JSON.stringify([
              {
                number: 22,
                title: "Merged PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/22",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 23,
                title: "Merged PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/23",
            ...
            JSON.stringify([
              {
                number: 45,
                title: "Merged PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/45",
                baseRefName: "main",
              ...
              },
              {
                number: 46,
                title: "Open PR",
                url: "https://github.com/viperisuseful/codething-mvp/pull/46",
                baseRefName: "main",
                headRefName: "feature/status-open-over-merged",
                state: "OPEN",
                updatedAt: "2026-01-30T10:00:00Z",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/viperisuseful/codething-mvp/pull/77",
                  baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/viperisuseful/codething-mvp/pull/303",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/viperisuseful/codething-mvp/pull/404",
                baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/viperisuseful/codething-mvp/pull/142",
                  baseRefName: "main",
                  headRefName: "statemachine",
                  state: "OPEN",
                  isCrossRepository: true,
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["remote", "add", "fork-seed", forkDir]);
        yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
        yield* runGit(repoDir, ["checkout", "-b", "vipercode/pr-142/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* configureVisibleRemoteUrlWithLocalRewrite(
          repoDir,
          "fork-seed",
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              "vipercode/pr-142/statemachine": JSON.stringify([]),
              // @effect-diagnostics-next-line preferSchemaOverJson:off
              statemachine: JSON.stringify([
                {
                  number: 41,
                  title: "Unrelated same-repo PR",
                  url: "https://github.com/viperisuseful/codething-mvp/pull/41",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
            ...
            JSON.stringify([
              {
                number: 88,
                title: "Add stacked git actions",
                url: "https://github.com/viperisuseful/codething-mvp/pull/88",
                baseRefName: "main",
              ...
              JSON.stringify([
                {
                  number: 188,
                  title: "Add stacked git actions",
                  url: "https://github.com/viperisuseful/codething-mvp/pull/188",
                  baseRefName: "main",
                  headRefName: "feature/no-fork-match",
                  state: "OPEN",
  ...
  it.effect("creates cross-repo PRs with the fork owner selector and default base branch", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, ["commit", "-m", "Feature commit"]);
      yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
      yield* runGit(repoDir, ["checkout", "-b", "vipercode/pr-91/statemachine"]);
      yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
      yield* configureVisibleRemoteUrlWithLocalRewrite(
        repoDir,
        "fork-seed",
      ...
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 64,
            title: "Local PR",
            url: "https://github.com/viperisuseful/codething-mvp/pull/64",
            baseRefName: "main",
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/viperisuseful/codething-mvp/pull/65",
              baseRefName: "main",
              headRefName: "feature/pr-local-upstream",
              state: "open",
              isCrossRepository: false,
              headRepositoryNameWithOwner: "viperisuseful/codething-mvp",
              headRepositoryOwnerLogin: "viperisuseful",
            },
            repositoryCloneUrls: {
              "viperisuseful/codething-mvp": {
                url: remoteDir,
                sshUrl: remoteDir,
              },
            },
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/viperisuseful/codething-mvp/pull/66",
              baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/viperisuseful/codething-mvp/pull/177",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 81,
            title: "Fork PR",
            url: "https://github.com/viperisuseful/codething-mvp/pull/81",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 82,
            title: "Local Fork PR",
            url: "https://github.com/viperisuseful/codething-mvp/pull/82",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/Viperisuseful/ViperCode/pull/642",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/viperisuseful/codething-mvp/pull/78",
            baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              number: 91,
              title: "Fork main PR",
              url: "https://github.com/viperisuseful/codething-mvp/pull/91",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("vipercode/pr-91/main");
        expect(result.worktreePath).not.toBeNull();
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/viperisuseful/codething-mvp/pull/92",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("vipercode/pr-92/main");
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/viperisuseful/codething-mvp/pull/83",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/viperisuseful/codething-mvp/pull/184",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 79,
            title: "Root-only PR",
            url: "https://github.com/viperisuseful/codething-mvp/pull/79",
            baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/viperisuseful/codething-mvp/pull/201",
                baseRefName: "main",
