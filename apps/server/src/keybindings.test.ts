import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@vipercode/contracts";
...
import { KeybindingsConfigError } from "@vipercode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "vipercode-keybindings-test-",
        }),
      ),
    ),
  );
