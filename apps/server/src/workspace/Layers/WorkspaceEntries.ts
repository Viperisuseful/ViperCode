...
import { type FilesystemBrowseInput, type ProjectEntry } from "@vipercode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@vipercode/shared/path";
import {
