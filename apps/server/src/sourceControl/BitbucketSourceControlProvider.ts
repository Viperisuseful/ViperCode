...
import { SourceControlProviderError, type ChangeRequest } from "@vipercode/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set VIPERCODE_BITBUCKET_EMAIL and VIPERCODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
