...
import { type DeepPartial, deepMerge } from "@vipercode/shared/Struct";
import { fromJsonStringPretty, fromLenientJson } from "@vipercode/shared/schemaJson";
...
export class ServerSettingsService extends Context.Service<
  ...
  ServerSettingsShape
>()("viper/serverSettings/ServerSettingsService") {
