...
import { type GrokSettings, type ModelSelection } from "@vipercode/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@vipercode/shared/git";
import { extractJsonObject } from "@vipercode/shared/schemaJson";
  ...
  const runGrokJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeGrokAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "viper-code-git-text", version: "0.0.0" },
      });
