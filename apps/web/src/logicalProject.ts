import { scopedProjectKey, scopeProjectRef } from "@vipercode/client-runtime";
import type { ScopedProjectRef, SidebarProjectGroupingMode } from "@vipercode/contracts";
import type { UnifiedSettings } from "@vipercode/contracts/settings";
