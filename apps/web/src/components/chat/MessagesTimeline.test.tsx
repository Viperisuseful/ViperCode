import { EnvironmentId, MessageId } from "@vipercode/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/vipercode/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/vipercode"
      />,
    );

    expect(markup).toContain("vipercode/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/vipercode/apps/web/src/session-logic.ts");
  });
