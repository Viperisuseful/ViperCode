...
export const PERSISTED_STATE_KEY = "vipercode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "vipercode:renderer-state:v8",
  "vipercode:renderer-state:v7",
  "vipercode:renderer-state:v6",
  "vipercode:renderer-state:v5",
  "vipercode:renderer-state:v4",
  "vipercode:renderer-state:v3",
