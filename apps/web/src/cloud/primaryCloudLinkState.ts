...
import type { EnvironmentCloudLinkStateResult, EnvironmentId } from "@vipercode/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Viper Connect link state.";
  }
