...
export const CLIENT_SETTINGS_STORAGE_KEY = "vipercode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "vipercode:saved-environment-registry:v1";
