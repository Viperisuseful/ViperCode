...
import { isProviderDriverKind, ProviderDriverKind } from "@vipercode/contracts";
import type { ThreadId, TurnId } from "@vipercode/contracts";
import * as Schema from "effect/Schema";
import { resolveModelSlugForProvider } from "@vipercode/shared/model";
...
export interface EnvironmentState {
  ...
  // createThreadDetailManager from @vipercode/client-runtime. New shared behavior
