...
import { parseScopedThreadKey, scopedThreadKey } from "@vipercode/client-runtime";
import { type ScopedThreadRef } from "@vipercode/contracts";
...
const TERMINAL_UI_STATE_STORAGE_KEY = "vipercode:terminal-state:v1";
