...
const ROUTER_HOST = "app.vipercode.app";
const HOSTED_WEB_CHANNEL_COOKIE = "vipercode_web_channel";
const LATEST_ORIGIN = "https://latest.app.vipercode.app";
const NIGHTLY_ORIGIN = "https://nightly.app.vipercode.app";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @vipercode/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
    deploymentEnabled: false,
  },
  installCommand:
    "npm install -g vite-plus && vp install --filter '@vipercode/scripts...' --filter '@vipercode/web...'",
  routes: [
    {
      src: "/__vipercode/channel",
