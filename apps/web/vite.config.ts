...
const configuredRelayUrl = repoEnv.VITE_VIPERCODE_RELAY_URL?.trim() || "";
...
const sourcemapEnv = process.env.VIPERCODE_WEB_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_VIPERCODE_RELAY_URL": JSON.stringify(configuredRelayUrl),
